...
const Contact = () => {
  return (
    <Section height={"screen"} id="contato" className="text-white">
      <div>
        <motion.span
          initial={{ opacity: 0 }}
      ...
      <div className="mx-4 mt-4 flex items-center justify-center text-center">
        <p className="max-w-2xl font-semibold text-gray-500">
      ...
      <div>
        ...
        <div className="mt-6 flex items-center justify-center">
          <div className="rounded-lg border-2 border-[#7c7abf7c] bg-[#7c7abf]/5 px-16 py-10">
            ...
            >
              <Phone />
              <span className="font-semibold">Telefone: (61) 98447-3234</span>
            </div>
          </div>
        </div>
      </div>
