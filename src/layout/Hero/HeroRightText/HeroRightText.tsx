  ...
  return (
    ...
    >
      <Image
        src={nameLogo}
        alt="João Gabriel"
        className={`relative -top-2 h-auto w-full max-w-[250px] object-contain sm:max-w-[440px] md:left-4 md:max-w-[640px] lg:-left-8 lg:mb-8 lg:max-w-[860px] lg:scale-125 xl:-left-10 xl:mb-12 xl:max-w-[1000px] xl:scale-150 ${orderClass[order]}`}
        priority
      />
    </motion.div>
  );
