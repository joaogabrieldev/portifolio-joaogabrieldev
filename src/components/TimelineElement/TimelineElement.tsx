...
const TimelineElement = ({icon, date, title, description}: ITimelineElementProps) => {
  return (
        ...
        contentStyle={
          {
            ...
            color: "#ffffff", 
            boxShadow: "rgba(117, 117, 117, 0.25) 0px 50px 100px -20px, rgba(126, 126, 126, 0.3) 0px 30px 60px -30px",
