  ...
  return (
    <>
      <motion.article
        ...
        className={`group hover:shadow-[0_0_0_1px_rgba(255,255,255,0.06), 0_24px_48px_-24px_rgba(0,0,0,0.8)] relative cursor-pointer overflow-hidden rounded-xl border border-white/8 bg-white/3 backdrop-blur-[2px] transition-[border-color,box-shadow] duration-300 hover:border-white/14 ${outfit.className}`}
      ...
      >
        ...
        <div className={`space-y-3 p-5 pt-4 ${dmSans.className}`}>
          <div className="flex flex-wrap items-start justify-between gap-2">
            ...
            <time
              className="shrink-0 text-xs font-medium text-white/35 tabular-nums"
              dateTime={isoDate}
            >
          ...
          <div className="flex items-center justify-between pt-1">
            <button
              ...
              className={`text-sm font-medium text-white/40 transition hover:text-white/70 ${outfit.className} cursor-pointer`}
            >
              Ver detalhes
            </button>
            ...
            <Link
              ...
              className={`inline-flex items-center gap-1.5 text-sm font-medium text-violet-300/90 transition hover:text-violet-200 ${outfit.className}`}
            >
              Abrir projeto
